...
type ArgoCDProviderStatus struct {
	...
	// ServerHealth contains the health status of the ArgoCD server
	// +optional
	ServerHealth ArgoCDServerHealth `json:"serverHealth,omitempty"`

	// ApplicationController indicates if the application controller is ready
	// +optional
	ApplicationControllerReady bool `json:"applicationControllerReady,omitempty"`
}

// ArgoCDServerHealth contains health status information about the ArgoCD server
type ArgoCDServerHealth struct {
	// Status is the health status (e.g., Healthy, Degraded, Progressing)
	// +optional
