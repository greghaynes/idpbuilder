...
type NginxGatewaySpec struct {
	...
	// DefaultTLS defines the default TLS configuration
	// +optional
	DefaultTLS *NginxTLSConfig `json:"defaultTLS,omitempty"`
}

// NginxIngressClass defines the ingress class configuration for Nginx
type NginxIngressClass struct {
	// Name is the ingress class name
	// +optional
	// +kubebuilder:default="nginx"
	Name string `json:"name,omitempty"`

	// IsDefault indicates whether this should be the default ingress class
	// +optional
	// +kubebuilder:default=true
	IsDefault bool `json:"isDefault,omitempty"`
}

// NginxTLSConfig defines TLS configuration for Nginx
...
type NginxGatewayStatus struct {
	...
	// IngressClassName is the ingress class name to use in Ingress resources
	...
	// Phase represents the current phase of the Nginx provider (e.g., Pending, Installing, Ready, Failed)
	// +optional
...
// +kubebuilder:printcolumn:name="Endpoint",type=string,JSONPath=`.status.loadBalancerEndpoint`
